...
public class OkUtils {
    ...
    public static void UploadFileMore(String url,String key,List<String> paths,Callback callback){
        if(paths!=null){
            //创建文件集合
     ...
     * */
    @SuppressWarnings("unused")
    public static void UploadFileSCMore(String url,String key1,List<String> key_list,List<String> paths,Map<String, String> map,Callback callback){
        if(paths!=null&&map!=null){
            ...
            for (File file : list) {
                if(file!=null){
                    builder.addFormDataPart(key1, file.getName(),RequestBody.create(MEDIA_TYPE_PNG, file));
                }
            }
    ...
    //get请求
    public static void getSJ(String url,Callback callback){
